    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span
              style={{ fontWeight: "700", fontSize: "12px", color: "white" }}
            >
            ...
            style={{
              ...
              boxShadow: canDrawCard
                ? isDark
                  ...
                  : "0 6px 16px -2px rgba(16, 185, 129, 0.3)"
                : "none",
          ...
          >
            ...
            >
              {userColor === currentPlayer ? (
                canDrawCard ? (
                  <>
                    <Play style={{ width: "20px", height: "20px" }} /> Draw{" "}
                    {cardsToDrawCount > 1
                      ? `${cardsToDrawCount} Cards`
                      : "Card"}
                  </>
                ) : (
                  "Make Your Move"
